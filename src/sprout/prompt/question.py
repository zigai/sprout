...
from sprout.prompt.validation import ValidatorType
...
def parse_yes_no(value: str, answers: AnswerMap) -> bool:
    """
    Parse a yes-or-no string and return a boolean value.

    Args:
        value (str): Raw answer text.
        answers (AnswerMap): Previously collected answers. This parameter is unused.
...
__all__ = ["YES_NO_CHOICES", "AnswerMap", "DefaultValue", "Question", "parse_yes_no"]
