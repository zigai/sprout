...
def test_add_prompts_with_derived_name(
    ...
    monkeypatch.setattr("sprout.cli.commands.ask_question", fake_ask)
...
def test_add_duplicate_requires_and_honors_confirmation(
    ...
    monkeypatch.setattr("sprout.cli.commands.ask_question", lambda *_args: False)
    ...
    monkeypatch.setattr("sprout.cli.commands.ask_question", lambda *_args: True)
